...
predictfilter='juno_sc_raw_??????_??????.bc;juno_sc_prl_??????_??????_jm????rp_v??.bc;juno_sc_prl_??????_??????_jm????a_v??.bc;juno_sc_prl_??????_??????_jm????b_v??.bc' \
recondir=/Volumes/TouchT7/SPICE/juno/kernels/ck \
reconfilter='juno_sc_rec_??????_??????_v??.bc' \
sclk=/Volumes/TouchT7/SPICE/juno/kernels/sclk/jno_sclkscet_00141.tsc \
